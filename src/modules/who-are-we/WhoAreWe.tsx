        ...
        >
          {cards.map((card) => {
            ...
            return (
              ...
              >
                <div
                  className={`relative border-2 border-white/20 overflow-hidden p-5 md:p-6 lg:p-8 flex flex-col h-[300px] md:h-[340px] lg:h-[380px] w-full max-[414px]:h-[260px] max-[414px]:p-3 rounded-lg md:rounded-xl ${
                    card.hasGradient
                      ? ''
                ...
                >
                  ...
                  <div className="relative z-10 flex items-center justify-center flex-1 pt-2 md:pt-3">
                    <Image
                      ...
                      width={200}
                      height={300}
                      className="h-auto w-auto max-h-24 md:max-h-28 lg:max-h-32 max-[414px]:max-h-20"
                      aria-hidden="true"
                    />
                  </div>
                </div>
