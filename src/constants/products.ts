...
export const PRODUCT_CONFIGS: Record<ProductSlug, ProductConfig> = {
  ...
  geko: {
    ...
    cornerIcon: {
      ...
      width: 320,
      height: 320,
      className: 'h-auto w-52 sm:w-60 md:w-64 lg:w-72 max-md:!w-44 max-[389px]:!w-32',
      position: 'bottom-5 right-5 translate-x-[8%] translate-y-[8%] max-[389px]:bottom-2 max-[389px]:right-2',
    },
    buttonStyle: 'white',
  },
  deko: {
