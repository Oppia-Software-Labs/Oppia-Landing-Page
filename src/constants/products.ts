  ...
  neko: {
    ...
    logo: {
      active: {
        ...
        width: 380,
        height: 380,
        className: 'h-[380px] w-[380px] max-md:h-[260px] max-md:w-[260px] max-[414px]:h-[180px] max-[414px]:w-[180px] brightness-0 invert',
      },
      inactive: {
        src: '/oppia-projects/Neko-Project.svg',
        width: 280,
        height: 280,
        className: 'h-[280px] w-[280px] max-md:h-[180px] max-md:w-[180px] max-[414px]:h-[130px] max-[414px]:w-[130px]',
      },
    },
    buttonStyle: 'white',
  },
  geko: {
    ...
    logo: {
      active: {
        ...
        width: 350,
        height: 350,
        className: 'h-auto w-56 sm:w-64 md:w-72 lg:w-80 max-md:!w-44 max-[414px]:!w-32',
      },
      inactive: {
        src: '/oppia-projects/Geko.svg',
        width: 200,
        height: 200,
        className: 'h-[200px] w-[200px] max-md:h-[140px] max-md:w-[140px] max-[414px]:h-[100px] max-[414px]:w-[100px]',
      },
    },
    cornerIcon: {
      src: '/oppia-projects/Geko.svg',
      width: 320,
      height: 320,
      className: 'h-auto w-52 sm:w-60 md:w-64 lg:w-72 max-md:!w-44 max-[414px]:!w-32',
      position: 'bottom-5 right-5 translate-x-[8%] translate-y-[8%] max-[414px]:bottom-2 max-[414px]:right-2',
    },
    buttonStyle: 'white',
  },
  deko: {
