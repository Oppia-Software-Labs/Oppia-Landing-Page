/**
 * RightWave component
 * Displays a decorative wave SVG on the right side
 */
export function RightWave() {
  const gradientId1 = 'right-wave-gradient-1';
  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-0 h-full w-full overflow-hidden">
      <svg
        ...
        className="absolute right-0 top-0 h-full w-auto opacity-80 scale-[0.35] sm:scale-[0.55] md:scale-[0.75] lg:scale-100 origin-right"
        aria-hidden="true"
      ...
      >
        ...
        <defs>
          ...
          <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop offset="0.396901" stopColor="#03A7FF" />
            <stop offset="0.750563" stopColor="#061A4B" />
