...
export function ProductButton({ text, onClick, variant = 'gray', disabled = false }: ProductButtonProps) {
  const baseClasses = 'mb-4 w-fit rounded-full px-6 py-2 text-xs font-medium transition-all duration-400 max-md:mb-2.5 max-md:px-4 max-md:py-1.5 max-md:text-[11px] max-[389px]:mb-2 max-[389px]:px-3 max-[389px]:py-1 max-[389px]:text-[10px]';
